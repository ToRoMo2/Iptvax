...
export function Movies() {
  ...
  // tmdbService.isEnabled() suit l'abonnement (cf. §X). Reste vide pour le tier
  // gratuit → le CTA <PopularLocked> est affiché à la place.
  ...
  }, [allStreams, allGroups, isPremium]);
