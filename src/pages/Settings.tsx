      ...
      <div className={styles.content}>
        ...
        {tab === 'account' && (
          <>
            {userInfo && (
              <div className={styles.section}>
                <div className={styles.sectionHeader}>
                  ...
                  <div className={styles.sectionDesc}>Votre abonnement Xtream Codes actuel</div>
                </div>
                <InfoRow label="Utilisateur" value={userInfo.username} />
                <div className={styles.row}>
                  <span className={styles.rowLabel}>Statut</span>
                  <span className={`${styles.badge} ${isExpired ? styles.badgeYellow : styles.badgeGreen}`}>
                    <span className={styles.badgePulse} />
                    {isExpired ? 'Expiré' : 'Actif'}
                  </span>
                </div>
                {expiryDate && (
                  <InfoRow label="Expiration" value={expiryDate} />
                )}
            ...
            {credentials && (
              <div className={styles.section}>
                <div className={styles.sectionHeader}>
                  <div className={styles.sectionTitle}>Serveur</div>
                  <div className={styles.sectionDesc}>Connexion Xtream Codes</div>
                </div>
            ...
            <div className={styles.dangerSection}>
              <div className={styles.dangerHeader}>
                ...
                <div className={styles.dangerDesc}>Ces actions sont irréversibles</div>
              </div>
        ...
        {tab === 'playback' && (
          <>
            <div className={styles.section}>
              <div className={styles.sectionHeader}>
                <div className={styles.sectionTitle}>Lecture automatique</div>
                <div className={styles.sectionDesc}>Comportement au démarrage des médias</div>
              </div>
              <ToggleRow
                id="autoplay"
            ...
            <div className={styles.section}>
              <div className={styles.sectionHeader}>
                ...
                <div className={styles.sectionDesc}>Options de décodage vidéo</div>
              </div>
              <ToggleRow
                id="hwdecode"
            ...
            <div className={styles.section}>
              <div className={styles.sectionHeader}>
                <div className={styles.sectionTitle}>Format de flux</div>
                <div className={styles.sectionDesc}>Protocole de streaming utilisé</div>
              </div>
        ...
        {tab === 'about' && (
          <>
            <div className={styles.section}>
              <div className={styles.sectionHeader}>
                <div className={styles.sectionTitle}>Aurora IPTV</div>
                <div className={styles.sectionDesc}>Client Xtream Codes premium</div>
              </div>
            ...
            <div className={styles.section}>
              <div className={styles.sectionHeader}>
                <div className={styles.sectionTitle}>Fonctionnalités</div>
              </div>
