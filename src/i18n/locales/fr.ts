...
const fr = {
  ...
  downloads: {
    ...
    emptyHint: 'Téléchargez un film ou un épisode pour le regarder hors-ligne, sans connexion.',
    ...
    cancel: 'Annuler',
    playOffline: 'Lire',
    premiumOnly: 'Le téléchargement hors-ligne est réservé aux membres Premium.',
    unavailable: 'Le téléchargement n’est disponible que sur les applications Android et Windows.',
    confirmRemove: 'Supprimer ce téléchargement ?',
    offlineMode: 'Mode hors-ligne',
    accessOffline: 'Accéder à mes téléchargements',
    movies: 'Films',
    series: 'Séries',
  },
  home: {
